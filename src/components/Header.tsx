    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          {/* Logo & Brand Name */}
          <a href="#hero" className="flex items-center gap-3 group transition-transform duration-200" id="brand-logo">
          ...
          <nav className="hidden md:flex items-center gap-1.5" id="desktop-nav">
            {navLinks.map((link) => (
              <a
                key={link.name}
                href={link.href}
                className="relative rounded-full px-4 py-2 text-sm font-medium text-gray-300 hover:text-white transition-colors duration-200 after:absolute after:bottom-1 after:left-1/2 after:h-[2px] after:w-0 after:-translate-x-1/2 after:bg-cyan-400 after:transition-all after:duration-300 hover:after:w-4"
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            >
              Consultation <Rocket className="h-3.5 w-3.5 group-hover:translate-x-0.5 transition-transform" />
          ...
          <button
            ...
            className="rounded-lg border border-white/10 bg-white/5 p-2 text-gray-300 hover:bg-white/10 hover:text-white md:hidden transition-all"
      ...
      {isMobileMenuOpen && (
        <div 
          className="fixed inset-x-0 top-[73px] z-[39] bg-[#070b19] border-b border-white/10 p-6 md:hidden animate-slideDown"
          ...
          <div className="flex flex-col gap-4">
            {navLinks.map((link) => (
              <a
                ...
                className="rounded-lg bg-white/5 px-4 py-3 text-sm font-medium text-gray-200 hover:bg-white/10 hover:text-white transition-all"
